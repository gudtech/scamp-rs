...
mod tests {
    ...
    fn make_request_header(action: &str, version: i32, request_id: i64) -> PacketHeader {
        PacketHeader {
    ...
    /// Write a complete request (HEADER + optional DATA chunks + EOF) to a stream.
    ...
    fn parse_all_packets(data: &[u8]) -> Vec<Packet> {
